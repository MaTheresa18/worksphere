<template>
    <div class="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-950">
        ...
        >
            <div class="space-y-6">
                <div class="rounded-md bg-blue-50 dark:bg-blue-900/20 p-4 border border-blue-100 dark:border-blue-900/50">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <InfoIcon class="h-5 w-5 text-blue-400" aria-hidden="true" />
                        </div>
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700 dark:text-blue-300">
                                <p>
                                    To create your account, you must review and agree to our
                                    <a href="/terms" target="_blank" class="font-medium underline hover:text-blue-600">Terms of Service</a>
                                    and
                                    <a href="/privacy" target="_blank" class="font-medium underline hover:text-blue-600">Privacy Policy</a>.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex items-start bg-gray-50 dark:bg-gray-800/50 p-3 rounded-lg border border-gray-100 dark:border-gray-800">
                    <div class="flex items-center h-5">
                        <Checkbox id="terms" v-model="agreed" />
                    </div>
                    <div class="ml-3 text-sm">
                        <label for="terms" class="font-medium text-gray-700 dark:text-gray-300 cursor-pointer select-none">
